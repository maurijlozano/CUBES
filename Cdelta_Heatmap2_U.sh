...
echo "
        ...
        -h Show this Help
"
echo -e '\nCalculates FUC_CCmax-FUC_CCmin and generates a heatmap including Ws (calculated without normalization by the maximum value, and including U:U wooble base interaction.\n\n'
exit 1
}
...
ls -d */ | while read F; do 
    ...
    cd ..
    Rscript --vanilla heatmap2_U.r "./${F}" "${FN}"
