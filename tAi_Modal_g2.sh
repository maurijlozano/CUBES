...
ls -d */ | while read F; do 
    ...
    if [[ ! -f s_opts_DCBS_GNM2.txt ]] ; then
        echo 'File "s_opts_DCBS_GNM2.txt" is not there, skipping.'
        cd ..
        continue
    fi
    ...
    Rscript --vanilla Tai_modal_g2.R "./${F}"
