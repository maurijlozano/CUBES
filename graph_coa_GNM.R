...
svg(filename="CA_genes_GNM.svg", width=5, height=4, pointsize=10)
...
svg(filename="CA_genes2_GNM.svg", width=5, height=4, pointsize=10)
...
if (length(woPHE$class) != 0) {
    ...
    svg(filename="CA_genes_GNM_woPHE.svg", width=5, height=4, pointsize=10)
...
theme(axis.text.x = element_text(size=14),
    ...
    svg(filename="CA_genes2_GNM_woPHE.svg", width=5, height=4, pointsize=10)
