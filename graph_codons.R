...
svg(filename="CA_codons_C.svg", width=5, height=4, pointsize=10)
...
geom_text_repel(aes(label=label, fontface=1), size = 3.5, point.padding = 1 , arrow = arrow(length = unit(0.01, 'npc'))) +
theme_calc() +
